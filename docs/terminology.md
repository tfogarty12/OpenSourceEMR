...
Building and *maintaining* a safe, current drug-knowledge base (interactions,
...
*more* dangerous than integrating a maintained source. We therefore integrate,
...
## Versioning & safety
- Terminology is **versioned**; a coded clinical fact records the code *and* the
